...
import org.runelive.mac.Updater;
...
public final class GameWindow extends JFrame implements ActionListener {
    ...
    public void createImgurUploadFrame() {
        ...
        try {
            icons2.add(ImageIO.read(GameWindow.class.getResourceAsStream("/org/runelive/client/resources/imgur-16x16.png.png")));
            icons2.add(ImageIO.read(GameWindow.class.getResourceAsStream("/org/runelive/client/resources/imgur-32x32.png.png")));
            icons2.add(ImageIO.read(GameWindow.class.getResourceAsStream("/org/runelive/client/resources/imgur-96x96.png.png")));
            icons2.add(ImageIO.read(GameWindow.class.getResourceAsStream("/org/runelive/client/resources/imgur-152x152.png.png")));
        } catch (IOException e) {
            e.printStackTrace();
        }
        try {
        ...
        localJButton2.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/org/runelive/client/resources/open_web.png"))));
        ...
        localJButton3.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/org/runelive/client/resources/copy_url.png"))));
        ...
        localJButton4.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/org/runelive/client/resources/save_image.png"))));
...
*/
    ...
    private void drawMenuBar() {
        ...
        localJButton1.setToolTipText("Opens the RuneLive homepage in your web browser.");
        localJButton1.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/org/runelive/client/resources/home_icon.png"))));
        variable1.add(localJButton1);
        JButton localJButton2 = new JButton("Forum");
        localJButton2.setBorderPainted(false);
        localJButton2.addActionListener(this);
        localJButton2.setActionCommand("forum");
        localJButton2.setToolTipText("Opens the RuneLive forum in your web browser.");
        localJButton2.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/org/runelive/client/resources/forum_icon.png"))));
        variable1.add(localJButton2);
        JButton localJButton3 = new JButton("Store");
        localJButton3.setBorderPainted(false);
        localJButton3.addActionListener(this);
        localJButton3.setActionCommand("store");
        localJButton3.setToolTipText("Opens the RuneLive store in your web browser.");
        localJButton3.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/org/runelive/client/resources/store_icon.png"))));
        variable1.add(localJButton3);
        JButton localJButton4 = new JButton("Vote");
        localJButton4.setBorderPainted(false);
        localJButton4.addActionListener(this);
        localJButton4.setActionCommand("vote");
        localJButton4.setToolTipText("Opens the RuneLive vote in your web browser.");
        localJButton4.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/org/runelive/client/resources/vote_icon.png"))));
        ...
        localJButton5.setToolTipText("Opens the RuneLive hiscores in your web browser.");
        localJButton5.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/org/runelive/client/resources/hiscore_icon.png"))));
        ...
        localJButton6.setToolTipText("Opens the RuneLive Facebook in your web browser.");
        localJButton6.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/org/runelive/client/resources/facebook_icon.png"))));
        ...
        localJButton7.setToolTipText("Opens the RuneLive YouTube page in your web browser.");
        localJButton7.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/org/runelive/client/resources/youtube_icon.png"))));
        ...
        jbutton.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/org/runelive/client/resources/monitor_icon.png"))));
        ...
        variable6.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/org/runelive/client/resources/history_icon.png"))));
    ...
    public void actionPerformed(ActionEvent paramActionEvent) {
        ...
        if (str.equalsIgnoreCase("home")) {
            Client.launchURL("www.rune.live");
        } else if (str.equalsIgnoreCase("forum")) {
            Client.launchURL("www.rune.live/forums");
        } else if (str.equalsIgnoreCase("store")) {
            Client.launchURL("www.rune.live/store/");
        } else if (str.equalsIgnoreCase("vote")) {
            Client.launchURL("www.rune.live/vote/");
        } else if (str.equalsIgnoreCase("hiscore")) {
            Client.launchURL("www.rune.live/hiscores/");
