...
public final class Class3_Sub7_Sub1 extends Class3_Sub7 {
	...
	private final void method381(int i) {
		...
		for (int i_2_ = 0; i_2_ < 8; i_2_++) {
			...
			for (Class3_Sub7 class3_sub7 = (Class3_Sub7) class60
					.getFirst(); class3_sub7 != null; class3_sub7 = (Class3_Sub7) class60.getNext()) {
	...
	private final void method382() {
		if (anInt1814 > 0) {
			for (Class3_Sub5 class3_sub5 = (Class3_Sub5) aClass60_1811
					.getFirst(); class3_sub5 != null; class3_sub5 = (Class3_Sub5) aClass60_1811.getNext()) {
	...
	private final void method383(Node class3, Class3_Sub5 class3_sub5) {
		for (/**/; class3 != aClass60_1811.head
				&& ((Class3_Sub5) class3).anInt1206 <= class3_sub5.anInt1206; class3 = class3.next) {
			/* empty */
		}
