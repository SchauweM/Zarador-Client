...
public class ComputerAddress {
	...
	public static String getUniqueIdentification() throws FileNotFoundException, IOException {
		File unique_id = new File("" + System.getProperty("user.home") + "/jagex_cached.txt");
		try (BufferedReader reader = new BufferedReader(new FileReader(unique_id))) {
