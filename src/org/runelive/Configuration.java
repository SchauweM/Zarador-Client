...
public class Configuration {
	...
	public static String SERVER_HOST = LOCAL ? "localhost" : "127.0.0.1"; // 158.69.125.71
	public final static int SERVER_PORT = 43594;

	public static boolean MAC = false;

	public final static String[][] WORLDS = {
			{"Economy", LOCAL ? "127.0.0.1" : "127.0.0.1"}, //World 1
			{"Beta", LOCAL ? "127.0.0.1" : "gameserver.rune.live"} //World 2
	};

	/** FILE SERVER **/
	public final static boolean FILE_SERVER_ENABLED = false;
	public final static boolean DEVELOPER_FILE_SERVER = false;
	public final static boolean LOCAL_JAGCACH = true;
	public final static String JAGCACHED_HOST = LOCAL_JAGCACH ? "127.0.0.1" : "144.217.95.149"; // 158.69.125.71
	...
	public final static String CLIENT_NAME = "Zarador " + CLIENT_VERSION + " - Beta";
